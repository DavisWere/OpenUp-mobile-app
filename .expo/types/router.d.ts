...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(tabs)` | `/(tabs)/CustomHeader` | `/(tabs)/Login` | `/(tabs)/Signup` | `/(tabs)/WelcomeScreen` | `/..\components\subcomponents\Settings` | `/CustomHeader` | `/Login` | `/Signup` | `/WelcomeScreen` | `/_sitemap`;
