...
const Appointments: React.FC = () => {
  ...
  const upcomingAppointments = [
    { id: '1', therapist: 'Dr. John Doe', date: '2024-07-01', time: '10:00 AM' },
    { id: '2', therapist: 'Dr. Jane Smith', date: '2024-07-03', time: '2:00 PM' },
  ];


  
  const completedSessions = [
    { id: '1', therapist: 'Dr. Michael Brown', date: '2024-06-25', time: '11:00 AM' },
    { id: '2', therapist: 'Dr. John Doe', date: '2024-06-20', time: '9:00 AM' },
  ];
