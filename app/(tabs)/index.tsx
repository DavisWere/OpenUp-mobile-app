// Assuming this is in your main App.js or equivalent file
...
function TabNavigator() {
  return (
    ...
    >
      ...
      <Tab.Screen name="AI chat" component={AIchat} options={{ headerShown: false }} />
      <Tab.Screen name="Home" component={StackScreens} options={{ headerShown: false }} />
